...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Shopping.xml', function(err, result) {
      ...
      result.ShoppingList.section[obj.sec_n].entree.push({'item': obj.item, 'quantity': obj.quantity,'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names

...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Shopping.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Shopping.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Shopping.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.ShoppingList.section[obj.sec_n].articles.push({'item': obj.item, 'quantity': obj.quantity,'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('Shopping.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('Shopping.xml', function(err, result) {
      ...
      delete result.ShoppingList.section[obj.section].articles[obj.articles];
